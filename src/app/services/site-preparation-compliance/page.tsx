...
import { ArrowRight, CheckCircle, Phone, Shield, Truck, TestTube } from 'lucide-react';
              ...
              >
                ...
                >
                  ...
                  <motion.a
                    ...
                    whileTap={{ scale: 0.98 }}
                  >
                    <TestTube className="w-5 h-5 lg:w-5 lg:h-5 group-hover:rotate-12 transition-transform duration-300" />
              ...
              >
                ...
                >
                  <Image
                    ...
                    alt="Professional site preparation and soil testing"
                    width={600}
                    height={500}
                ...
                {/* Floating Site Preparation Badge */}
                <motion.div 
                ...
                >
                  <div className="text-xl lg:text-lg font-bold">Site Prep</div>
                  <div className="text-sm lg:text-xs opacity-90">Expert</div>
                </motion.div>
          ...
          <div className="septic-max-width px-4 lg:px-8 relative z-10">
            ...
            >
              <motion.h2 
                ...
                transition={{ duration: 0.8, delay: 0.2 }}
              >
                <span className="text-primary-dark">Site Preparation</span>
              ...
              <motion.p 
                ...
                transition={{ duration: 0.8, delay: 0.6 }}
              >
                Professional excavation, soil testing, and regulatory compliance services for successful septic projects
              </motion.p>
            </motion.div>
          ...
          <div className="septic-max-width px-4 lg:px-8">
            ...
            >
              ...
              <motion.p 
                ...
                transition={{ duration: 0.8, delay: 0.4 }}
              >
                Common questions about site preparation, soil testing, and regulatory compliance
              </motion.p>
            </motion.div>
          ...
          <div className="septic-max-width text-center z-10 px-4 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-gray-200 mb-12 max-w-3xl mx-auto leading-relaxed">
                Ensure your septic project starts right with professional site preparation and expert compliance support.
              </p>
